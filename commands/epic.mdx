...
An **engine-written** disposition — the migration's stamp, the archive-drift heal's — may be replaced by an agent recording a real one. Another agent's recorded judgment may not; correcting a mistaken disposition is not something this verb does.
