---
title: "Project Manager (PM) — A Claude Code Project Management Plugin"
sidebarTitle: "Home"
description: "A lightweight harness above OpenSpec and Superpowers that keeps a Claude Code project on track across detours, context compaction, and multiple epics in flight."
---

<Frame>
  ![Project Manager Pm Banner 1](/images/project-manager-pm-banner-1.png "Project Manager Pm Banner 1")
</Frame>

**Project Manager (PM)** is a lightweight harness above [OpenSpec](https://github.com/Fission-AI/OpenSpec) and [Superpowers](https://github.com/obra/superpowers) that keeps a Claude Code project on track — across detours, context compaction, and however many epics are in flight at once.

Install it once, run `/pm:init`, and it stays oriented across every context compaction. Zero npm dependencies. Pure Node 22\+ built-ins.

<CardGroup cols={2}>
  <Card title="Introduction" icon="circle-info" href="/introduction">
    Why PM exists, the problem it solves, and real numbers pulled from its own history.
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Zero Dependencies" icon="feather">
    The engine is pure Node 22\+ built-ins. Nothing to `npm install`, ever. See the [Introduction](/introduction) for current test/line counts.
  </Card>
