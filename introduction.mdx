...
| Metric | Value |
| --- | --- |
| Releases shipped end-to-end (spec → build → test → changelog → release) | **46** |
| Tests in the engine | **746** |
| Lines of engine code (`scripts/conductor.mjs` \+ `scripts/lib/*.mjs`) | **~7,900** |
