...
| Metric | Value |
| --- | --- |
| Releases shipped end-to-end (spec → build → test → changelog → release) | **59** |
| Tests in the engine | **1,393** |
| Lines of engine code (`scripts/conductor.mjs` + `scripts/lib/*.mjs`) | **~14,900** |
