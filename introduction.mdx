...
| Metric | Value |
| --- | --- |
| Releases shipped end-to-end (spec → build → test → changelog → release) | **58** |
| Tests in the engine | **1,307** |
| Lines of engine code (`scripts/conductor.mjs` + `scripts/lib/*.mjs`) | **~14,400** |
