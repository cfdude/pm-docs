---
title: "PM: Keep Claude Code Projects on Track"
sidebarTitle: "Introduction"
description: "PM is a Claude Code plugin that tracks epics, maintains a detour stack, and enforces a reconcile gate so nothing is lost across compaction or pivots."
---
...
<Note>
  PM runs exclusively in Claude Code today. Codex, Gemini CLI, Grok Build, and other `AGENTS.md`-based platforms are on the roadmap, tracked under `multi-platform-agent-support`.
</Note>
