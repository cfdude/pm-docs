...
| Metric | Value |
| --- | --- |
| Releases shipped end-to-end (spec → build → test → changelog → release) | **57** |
| Tests in the engine | **1,271** |
| Lines of engine code (`scripts/conductor.mjs` + `scripts/lib/*.mjs`) | **~14,200** |
