...
| Metric | Value |
| --- | --- |
| Releases shipped end-to-end (spec → build → test → changelog → release) | **60** |
| Tests in the engine | **1,584** |
| Lines of engine code (`scripts/conductor.mjs` + `scripts/lib/*.mjs`) | **~16,500** |
