...
description: "PM stores all project-management state in .conductor/state.json and renders a human-readable PROJECT.md view. Here is what each file contains and the rules around editing them."
---
...
```json
{
  ...
  "stories": [
    { "title": "TDD: remove-epic hard-delete, --cascade, link-stripping tests", "done": true },
